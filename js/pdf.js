...
import { punchItems } from './database.js';
    ...
    allPages += `
      <div class="pdf-page">
        ...
        <table class="pdf-table">
          <thead>
            <tr>
              <th>#</th><th>LOCATION</th><th>DESCRIPTION</th><th>PRI</th>
              <th>INSPECTION PHOTO</th><th>CLOSE-OUT PHOTO</th>
              <th>STATUS</th><th>DATES</th><th>REMARKS</th>
            </tr>
          </thead>
          <tbody>${rows}</tbody>
        </table>
...
export function previewPDF() {
  ...
  const html     = generatePDFHTML(punchItems, inspDate, projName, projLoc);
